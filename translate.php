...
try {
    ...
    $clientID     = "translation-voice-auto";
    //Client Secret key of the application.
    $clientSecret = "ultbs5LlCAqRPdEyzdec1Pp98JquwcRHsy222rUX9IE=";
    //OAuth Url.
    ...
    //Input String.
    $inputStr = isset($_POST['original_text']) ? $_POST['original_text'] : 'test';
    //HTTP Detect Method URL.
    $detectMethodUrl = 'http://api.microsofttranslator.com/V2/Http.svc/Translate?text='.urlencode($inputStr);
    $lang_from_string = isset($_POST['lang_from']) ? $_POST['lang_from'] : 'en';
    $lang_from_to     = isset($_POST['lang_to'])   ? $_POST['lang_to']   : 'ja';
    $detectMethodUrl .= '&from=' . $lang_from_string;
    $detectMethodUrl .= '&to=' . $lang_from_to;
